<?php /*a:1:{s:81:"D:\myphp_www\PHPTutorial\WWW\shang\application\admin\view\index\product_edit.html";i:1551727778;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<div class="page-container">
    <form action="<?php echo url('product_up_goods',['id'=>$productEdit['id']]); ?>" method="post" class="form form-horizontal" id="form-article-add">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>商品名称：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo htmlentities($productEdit['gt_name']); ?>" placeholder="" id="gt_name" name="gt_name">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="gt_unit" id="gt_unit" placeholder="商品的单位" value="<?php echo htmlentities($productEdit['gt_unit']); ?>" class="input-text" style=" width:25%">
            </div>
        </div>
        <!--		<div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="gt_number" id="gt_number" placeholder="商品编号" value="<?php echo htmlentities($productEdit['gt_number']); ?>" class="input-text" style=" width:25%">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="gt_barcode" id="gt_barcode" placeholder="条形码" value="<?php echo htmlentities($productEdit['gt_barcode']); ?>" class="input-text" style=" width:25%">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">现价：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="gt_curprice" id="gt_curprice" placeholder="现价" value="<?php echo htmlentities($productEdit['gt_curprice']); ?>" class="input-text" style=" width:25%">&nbsp;&nbsp;元
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">市场价：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="gt_oriprice" id="gt_oriprice" placeholder="市场价" value="<?php echo htmlentities($productEdit['gt_oriprice']); ?>" class="input-text" style=" width:25%">&nbsp;&nbsp;元
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">成本价：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="gt_cosprice" id="gt_cosprice" placeholder="成本价" value="<?php echo htmlentities($productEdit['gt_cosprice']); ?>" class="input-text" style=" width:25%">&nbsp;&nbsp;元
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">库存：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="gt_inventory" id="gt_inventory" placeholder="库存" value="<?php echo htmlentities($productEdit['gt_inventory']); ?>" class="input-text" style=" width:25%">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">限制购买量：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="gt_restrict" id="gt_restrict" placeholder="限制购买量" value="<?php echo htmlentities($productEdit['gt_restrict']); ?>" class="input-text" style=" width:25%">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">已经购买量：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="gt_already" id="gt_already" placeholder="已经购买量" value="<?php echo htmlentities($productEdit['gt_already']); ?>" class="input-text" style=" width:25%">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">运费：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="gt_freight" id="gt_freight" placeholder="已经购买量" value="<?php echo htmlentities($productEdit['gt_freight']); ?>" class="input-text" style=" width:25%">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">商品属性：</label>
            <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                <div class="check-box" value="<?php echo htmlentities($productEdit['gt_name']); ?>">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select name="gt_reorder" class="select">
...
<!--        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="gt_text" id="gt_text" placeholder="" value="<?php echo htmlentities($productEdit['gt_text']); ?>" class="input-text">
            </div>
        </div>-->
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <script name="gt_text" id="editor" type="text/plain" style="width:100%;height:400px;"><?php echo htmlentities($productEdit['gt_text']); ?></script>
                </div>
                </div>
                <div class="row cl">
