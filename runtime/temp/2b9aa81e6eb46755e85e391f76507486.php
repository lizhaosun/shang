<?php /*a:1:{s:78:"D:\myphp_www\PHPTutorial\WWW\shang\application\admin\view\user\member_add.html";i:1552901064;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<article class="page-container">
	<form action="" class="form-horizontal " method="post" id="login" name="login">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="password" class="input-text" value="" placeholder="" id="password_confirm" name="password_confirm">
            </div>
        </div>
...
/*
    ...
    submit.onclick = function () {
        ...
        var data = 'admin_user='+user+'&admin_password='+password;//生成post请求数据
        var url = 'insert';
